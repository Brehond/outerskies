...
class BasePlugin(ABC):
    ...
    def get_requirements(self):
        """
        Return additional Python requirements for the plugin
    ...
    def get_dependencies(self):
        """
        Return other plugins that this plugin depends on
    ...
    def validate_installation(self):
        ...
        """
        return True, "Plugin is properly installed"
    
    def get_plugin_info(self):
        """
        Return plugin information for the admin interface
        """
        return {
            'name': self.name,
    ...
    def render_template(self, template_name, context=None):
        ...
        # Add plugin context
        context.update(self.get_plugin_info())
    ...
    def log(self, message, level='info'):
        ...
        """
        import logging
        logger = logging.getLogger(f'plugins.{self.__class__.__name__}')
